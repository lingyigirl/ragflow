...
class CreateDatasetReq(Base):
    ...
    def validate_chunk_method(cls, v: Any, handler) -> Any:
        ...
        allowed = {"naive", "book", "email", "laws", "manual", "one", "hichunk", "financial", "paper", "picture", "presentation", "qa", "table", "tag"}
        error_msg = "Input should be 'naive', 'book', 'email', 'laws', 'manual', 'one', 'hichunk', 'financial', 'paper', 'picture', 'presentation', 'qa', 'table' or 'tag'"
