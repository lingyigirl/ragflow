...
class Document(DataBaseModel):
    ...
    llm_name = CharField(max_length=255, null=True, help_text="standard file name generated by llm", index=True) 
...
def migrate_db():
    ...
    try:
        ...
        pass
    try:
        migrate(migrator.add_column("document", "llm_name", CharField(max_length=255, null=True, help_text="standard file name generated by llm", index=True)))  # 迁移新增document.llm_name列
    except Exception:
        pass
    try:
