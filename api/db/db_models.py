...
class Document(DataBaseModel):
    ...
    llm_name = TextField(null=True, help_text="standard file name generated by llm")
...
def migrate_db():
    ...
    try:
        ...
        pass
    try:
        migrate(migrator.add_column("document", "llm_name", TextField(null=True, help_text="standard file name generated by llm")))  # 迁移新增document.llm_name列
    except Exception:
        pass
    try:
        migrate(migrator.alter_column_type("document", "llm_name", TextField(null=True, help_text="standard file name generated by llm")))  # 迁移将document.llm_name扩展为TEXT（约65535字节）
    except Exception:
        pass
    try:
