...
class Document(DataBaseModel):
    ...
    llm_name = LongTextField(null=True, help_text="standard file name generated by llm")
    llm_content = LongTextField(null=True, help_text="content supplied by user for llm naming")

    sha256_hash = CharField(max_length=64, null=True, index=True, help_text="SHA256 hash of document content")
    doc_type_en = CharField(max_length=128, null=True, help_text="English document type classification", index=True)
    doc_type_cn = CharField(max_length=128, null=True, help_text="Chinese document type classification")
...
class UserCanvas(DataBaseModel):
    ...
    params = JSONField(null=True, default=list, help_text="parameter settings array")
    dsl = JSONField(null=True, default={})
...
def migrate_db():
    ...
    try:
        ...
        pass
    try:
        migrate(migrator.add_column("document", "llm_name", LongTextField(null=True, help_text="standard file name generated by llm")))  # 迁移新增document.llm_name列
    except Exception:
        pass
    try:
        migrate(migrator.alter_column_type("document", "llm_name", LongTextField(null=True, help_text="standard file name generated by llm")))  # 迁移将document.llm_name扩展为LONGTEXT
    except Exception:
        pass
    try:
        migrate(migrator.add_column("document", "llm_content", LongTextField(null=True, help_text="content supplied by user for llm naming")))  # 迁移新增document.llm_content列
    except Exception:
        pass
    try:
    ...
    try:
        ...
        pass
    try:
        migrate(migrator.add_column("user_canvas", "agent_type_cn", CharField(max_length=255, null=True, help_text="agent type display name in Chinese")))
    except Exception:
        pass
    try:
        ...
        pass
    try:
        migrate(migrator.add_column("user_canvas", "params", JSONField(null=True, default=list, help_text="parameter settings array")))
    except Exception:
        pass
    try:
    ...
    try:
        ...
        pass
    try:
        migrate(migrator.add_column("document", "sha256_hash", CharField(max_length=64, null=True)))
        migrate(migrator.add_index("document", ("sha256_hash",), False))
    except Exception:
        pass
    try:
        migrate(migrator.add_column("document", "doc_type_en", CharField(max_length=128, null=True)))
    except Exception:
        pass
    try:
        migrate(migrator.add_column("document", "doc_type_cn", CharField(max_length=128, null=True)))
    except Exception:
        pass
