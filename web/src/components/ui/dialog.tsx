...
function containsDialogDescription(node: React.ReactNode): boolean {
  ...
  return React.Children.toArray(node).some((child) => {
    ...
    if (
      t === DialogPrimitive.Description ||
      t?.displayName === DialogPrimitive.Description.displayName
    ) {
      return true;
    }
    return containsDialogDescription(
...
>(({ className, children, ...props }, ref) => {
  const shouldOptOut =
    !containsDialogDescription(children) && !('aria-describedby' in props);
  return (
    <DialogPortal>
      <DialogOverlay />
      <DialogPrimitive.Content
        ...
        {...props}
        {...(shouldOptOut ? { 'aria-describedby': undefined } : {})}
      >
        {children}
